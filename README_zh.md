...
5. 默认情况下，goc使用编译产物的名称作为注册标识。你可以通过设置 `GOC_SERVICE_NAME` 环境变量以自定义该标识（可参见 [#293](https://github.com/zhouxiaoxiang1/goc/issues/293)）。 
...
感谢所有的[贡献者](https://github.com/zhouxiaoxiang1/goc/graphs/contributors)!!
